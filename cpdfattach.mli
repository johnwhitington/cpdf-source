...
(** [attach_file keepversion topage pdf relationship description filename] attaches the file in
...
val attach_file : ?memory:Pdfio.bytes -> bool -> int option -> Pdf.t -> string option -> string option -> string -> Pdf.t
