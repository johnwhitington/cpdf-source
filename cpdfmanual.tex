...
\noindent\small\verb!     [-dedup | -dedup-perpage] [-raw] [-inline] -o <path>!

\vspace{1.5mm}
\noindent\small\verb!cpdf -extract-single-image <object number>!\\
\noindent\small\verb!     [-im <path>] [-p2p <path>] [-raw] in.pdf -o <filename>!
...
\noindent This will extract the image at object 14 to \texttt{output.\{png, pnm, jpeg, jpeg2000, jbig2\}}. Any soft mask will be extracted with name \texttt{output-smask}. This single image extraction procedure does not work for lossy JBIG2 images with JBIG2Globals streams.
