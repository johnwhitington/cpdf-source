%Implement and Document -remove-embedded-standard-fonts -remove-alternate-images -remove-all-metadata (+ add to chapter 5 list)
...
\begin{description}
\item[\normalfont\texttt{-remove-files}] Chapter 12. Removes attached files from a PDF.
\item[\normalfont\texttt{-remove-annotations}] Chapter 10. Removes annotations from a PDF.
\item[\normalfont\texttt{-process-images}] Chapter 13. Lossy (and lossless) reprocessing of images within PDFs.
...
%\item[\normalfont\texttt{-remove-embedded-standard-fonts}] Chapter x. Does something
%\item[\normalfont\texttt{-remove-alternate-images}] Chapter x. Does something
%\item[\normalfont\texttt{-remove-all-metadata}] Chapter x. Does something
\end{description}
