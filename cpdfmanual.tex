...
\begin{description}
\item[Inversion] Adding \texttt{-redact-invert} and writing to another PDF will keep all objects redaction would lose, and lose all objects redaction would keep. Each object (image, vector, glyph) ends up only the redacted or inverted output. For example, we might
