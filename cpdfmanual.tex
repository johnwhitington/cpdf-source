...
\noindent\begin{longtable}{lp{10cm}l}
  \textbf{Number} & \textbf{Description} & \textbf{Reference} \\
  01-003 & Content marked as Artifact is present inside tagged content. & UA1:7.1-1\\
\multicolumn{3}{l}{This will be the remediation description}\\
...
\multicolumn{3}{l}{This will be the remediation description}\\
  ...
  13-004 & \textless Figure\textgreater\ tag alternative or replacement text missing. & UA1:7.3-3\\
\multicolumn{3}{l}{This will be the remediation description}\\

  14-002 & Does use numbered headings, but the first heading tag is not \textless H1\textgreater . & UA1:7.4.2-1\\
\multicolumn{3}{l}{This will be the remediation description}\\

  14-003 & Numbered heading levels in descending sequence are skipped (Example: \textless H3\textgreater\  follows directly after \textless H1\textgreater{}). & UA1:7.4-1\\
\multicolumn{3}{l}{This will be the remediation description}\\

  14-006 & A node contains more than one \textless H\textgreater\ tag. & UA1:7.4.4-1\\
\multicolumn{3}{l}{This will be the remediation description}\\

  14-007 & Document uses both \textless H\textgreater\ and \textless H\#\textgreater\ tags. & UA1:7.4.4-3\\
\multicolumn{3}{l}{This will be the remediation description}\\

  15-003 & In a table not organized with Headers attributes and IDs, a \textless TH\textgreater\ cell does not contain a Scope attribute. & UA1:7.5-2\\
\multicolumn{3}{l}{This will be the remediation description}\\

  17-002 & \textless Formula\textgreater\ tag is missing an Alt attribute. & UA1:7.7-1\\
\multicolumn{3}{l}{This will be the remediation description}\\

  17-003 & Unicode mapping requirements are not met. & UA1:7.7-2\\
\multicolumn{3}{l}{This will be the remediation description}\\

  19-003 & ID entry of the \textless Note\textgreater\ tag is not present. & UA1:7.9-2\\
\multicolumn{3}{l}{This will be the remediation description}\\

  19-004 & ID entry of the \textless Note\textgreater\ tag is non-unique. & UA1:7.9-2\\
\multicolumn{3}{l}{This will be the remediation description}\\
...
\multicolumn{3}{l}{This will be the remediation description}\\
  ...
  28-002 & An annotation, other than of subtype Widget, Link and PrinterMark, is not a direct child of an \textless Annot\textgreater\ structure element. & UA1:7.18.1-2\\
\multicolumn{3}{l}{This will be the remediation description}\\
...
\multicolumn{3}{l}{This will be the remediation description}\\
  ...
  28-010 & A widget annotation is not nested within a \textless Form\textgreater\ tag. & UA1:7.18.4-1\\
\multicolumn{3}{l}{This will be the remediation description}\\

  28-011 & A link annotation is not nested within a \textless Link\textgreater\ tag. & UA1:7.18.5-1\\
\multicolumn{3}{l}{This will be the remediation description}\\
