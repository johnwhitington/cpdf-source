%Implement and Document extraction of soft masks.
%Implement and Document reprocessing of JBIG2000 lossless into JBIG2000 lossy
%Implement and Document -1bpp-method-force to allow all directions
...
\chapter{Fonts}\pagestyle{fancy}\label{chap:14}
 {\small \begin{framed}
  ...
  \noindent\verb!cpdf -remove-embedded-standard-fonts in.pdf -o out.pdf!
