...
\chapter{Redaction}\label{chap:20}\pagestyle{fancy}\index{redaction}\index{redact}
  ...
  \noindent\verb!-redact-text [remove | no],[touching | enclosing]!\\
  \noindent\verb!-redact-images [remove | chop | no],[touching | enclosing]!\\
  \noindent\verb!-redact-inline-images [remove | chop | no],[touching | enclosing]!\\
  \noindent\verb!-redact-vectors [remove | no],[touching | enclosing]!\\
  \noindent\verb!-redact-annotations [remove | no],[touching | enclosing]!
