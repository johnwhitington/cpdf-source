%TODO: Document -redact-shape, -redact-apply, -redact-apply-type
%TODO: Document /Absolute for text and rectangle adding
%TODO: Document -add-annotation
...
\newcommand{\delannot}{Alternatively, use \texttt{-output-annotations-json} and \texttt{-set-annotations} as described in Chapter \ref{chap:10} to remove one or more specific annotations.}
...
\chapter{Redaction}\label{chap:20}\pagestyle{fancy}\index{redaction}\index{redact}
  ...
  \vspace{1.5mm}
  \noindent\verb!cpdf -annotate <rectangle> [-annot-type <type>] in.pdf -o out.pdf!
...
\noindent The redaction and annotation appearance options described above may be used here too. If the interactive software you are using to demarcate the annotations does not know about redaction annotations, you can use a different kind of annotation and Cpdf will use that annotation's bounding box as the redaction rectangle:
