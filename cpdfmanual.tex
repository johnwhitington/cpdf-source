%Document extraction of soft masks and mask changes to -list-images and friends
%Implement and Document CCITTG4 and Document CCITT in -process-images
%Document reprocessing of JBIG2000 lossless into JBIG2000 lossy -jbig2dec
%Document the empty range
%Check manually that all new 2.9 functionality is documented
%Document -process-images-force and mention it's always on for 1bpp reprocessing
