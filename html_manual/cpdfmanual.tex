...
\noindent\fbox{\parbox{\textwidth}{
  ...
  \texttt{     [-trans \textlangle\ transition-name\textrangle ] [-duration \textlangle\ float\textrangle\ ]}\\
\texttt{                     [-vertical] [-outward] [-direction \textlangle\ int \textrangle]}\\
\texttt{                     [-effect-duration \textlangle\ float \textrangle ]}\\
}}
