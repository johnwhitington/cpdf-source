...
let args =
  {op = None;
   ...
   path_to_p2p = begin match Sys.os_type with "Unix" -> "pnmtopng" | _ -> "pnmtopng.exe" end;
   path_to_jbig2enc = begin match Sys.os_type with "Unix" -> "jbig2enc" | _ -> "jbig2enc.exe" end;
   frombox = None;
   tobox = None;
